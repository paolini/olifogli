...
//            new Field('Cellulare_referente', 'Cellulare referente', ['contact_phone']),
            new Field('Codice_distretto', 'Codice distretto', ['venue.id']),
            new Field('Nome_distretto', 'Nome distretto', ['venue.name']),
            new Field('Email_coordinatori', 'Email coordinatori', ['coordinatori']),
